import removeDuplicates, {
  type ArrayOfNumberAndString,
} from '../../src/code-basics/type-annotations'

test('removeDuplicates', () => {
  expect(removeDuplicates([])).toEqual([])
  expect(removeDuplicates([2, 3, -100, -100, -100])).toEqual([2, 3, -100])
  expect(removeDuplicates(['as', 'good', 'as', 'it', 'gets'])).toEqual(['as', 'good', 'it', 'gets'])
...
describe('removeDuplicates', () => {
  ...
  test('should remove duplicates from an array of numbers and strings', () => {
