...
describe('isPairedBrackets', () => {
  test('should return true for strings with balanced paired brackets', () => {
  ...
  test('should return false for strings with unbalanced paired brackets', () => {
  ...
  test('should return true for strings without brackets', () => {
    expect(isPairedBrackets('')).toBe(true)
